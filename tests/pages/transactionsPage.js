...
export class TransactionsPage {
  constructor(page) {
    ...
    this.transactionsHeading = this.locator.getByRoleName('heading', 'Transactions');
    this.transactionsLink = this.locator.getByRoleName('link', 'Transactions');
    this.generalInformationButton = this.locator.getByRoleName('button', 'General information');
    this.newTransactionButton = this.locator.getByRoleName('button', 'New Transaction');
    this.sidebar = page.locator('.grid-sidebar');
    this.sidebarNewTransactionButton = this.locator.getByRoleName('button', 'New Transaction').last();    
    this.addNewTransactionHeading = this.locator.getByRoleName('heading', 'Add new transaction');
    ...
    this.checkButton = this.locator.getByRoleName('button', 'Check');
    ...
    this.cardNumberOption = this.locator.getByText('Card Number', { exact: true });
    this.cardNumberTexbox = this.locator.getByRoleName('textbox', 'Last 4 Digits');
    ...
    this.linkPaymentMethodButton = this.locator.getByRoleName('button', 'Link payment method');
    this.refundButton = this.locator.getByRoleName('button', 'Refund');
    this.voidButton = this.locator.getByRoleName('button', 'Void');
    this.transactionRefundedHeading = this.locator.getByRoleName('heading', 'Transaction refunded');
    this.transactionVoidedHeading = this.locator.getByRoleName('heading', 'Transaction voided');
