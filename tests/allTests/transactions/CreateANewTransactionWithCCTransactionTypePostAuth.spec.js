...
wait 3 seconds
click on the input below "TRANSACTION TYPE"
select "Post Auth"
enter "5555444433331111" near "Card Number"
wait 3 seconds
enter "01/28" to the right of "Card Number"
wait 3 seconds
enter "T4321A" below "Auth Code"
wait 3 seconds
...
test(' Create a new transaction with CC transaction type Post Auth', async ({ page }) => {
